        ...
        <div class="row mg-b-25">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="titulo" id="titulo" value="{{$galeria->titulo}}" placeholder="Titulo">
            ...
            <div class="col-lg-5">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="descripcion" id="descripcion" value="{{$galeria->descripcion}}">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="date" name="fecha_publicacion" id="fecha_publicacion" value="{{$galeria->fecha_publicacion}}" placeholder="http://">
