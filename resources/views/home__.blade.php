                    ...
                    <section class="p-1 p-2">
                        ...
                        <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="{{route('directorioweb')}}" class="bg_lightblue small p-4" style="color: #000000;"target="_blank">
                            ...
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                <a href="{{route('resoluciones')}}" class="bg_lightblue small p-4" style="color: #000000;"target="_blank">
                            ...
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="{{route('documentosdegestionweb')}}" class="bg_lightblue small p-4" style="color: #000000;"target="_blank">
                            ...
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="{{route('galerias')}}" class="bg_lightblue small p-4" style="color: #000000;"target="_blank">
                            ...
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                <a href="#"class="bg_lightblue small p-4" style="color: #000000;">
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                <a href="https://www.transparencia.gob.pe/reportes_directos/pte_transparencia_info_finan.aspx?id_entidad=14163&id_tema=19&ver=" class="bg_lightblue small p-4" style="color: #000000;" target="_blank">
                            ...
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                <a href="https://www.transparencia.gob.pe/reportes_directos/pte_transparencia_reg_visitas.aspx?id_entidad=14163&ver=&id_tema=500"class="bg_lightblue small p-4" style="color: #000000;"target="_blank">
                            ...
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                <a href="#"class="bg_lightblue small p-4" style="color: #000000;">
                                        <i class="fas fa-marker" style="color: black;"></i>
                                        Boletin Informativo
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                <a href="https://drive.google.com/file/d/1L9Wgx-IQWM0f_JGIHMTa7tFCDRF1_nXB/view?usp=sharing"class="bg_lightblue small p-4" style="color: #000000;">
                                        <i class="fa fa-telegram" style="color: black;"></i>
                                        Directorio DRE- UGEL
                                  </a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                <a href=" https://gestion.drehuanuco.gob.pe/tablas/evepublics"class="bg_lightblue small p-4" style="color: #000000;"target="_blank">
...
<section class="bg_gray mt-1 mb-0 pb-0">
    ...
    <?php if(isset($popup)){ ?>
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1965.0504075967679!2d-76.24013877373629!3d-9.925561429103821!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91a7c31d07ac6ced%3A0x5a73d4ab3e9545bb!2sDirecci%C3%B3n%20Regional%20de%20Educaci%C3%B3n%20-%20Hu%C3%A1nuco!5e0!3m2!1ses-419!2spe!4v1721684027001!5m2!1ses-419!2spe" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
